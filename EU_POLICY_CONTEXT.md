...
| **SOV-6 Technology** (15%) — open software, audit/modification rights, non-proprietary APIs | Open-source posture + [Platform Lock-in Declaration](PROPOSAL.md#improvement-9-platform-lock-in-declaration)                                      |
| **SOV-1 Strategic** (15%) — operational continuity if vendors disconnect                    | [Credit registry](PROPOSAL.md#improvement-3-credit-registries) — the day-1/day-2 [Carrez test](#the-european-preference-tension-with-open-source) |

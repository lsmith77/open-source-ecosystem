...
| **[TOOLING.md](TOOLING.md)**                     | Tooling ecosystem, gaps, and existing OSS building blocks — existing publiccode.yml tools, adjacent data sources, the new/adapted tools the proposal needs, and which open-source tools fill each gap | ~25 min | Tool builders, catalog/registry operators, implementers    | You want to build or extend tooling that supports the proposal          |
...
- [TOOLING.md → Tooling gaps](TOOLING.md#tooling-gaps)
...
- Add [TOOLING.md](TOOLING.md) for what to build or extend
- Use [GLOSSARY.md](GLOSSARY.md) as needed
